...
__IMPLEMENT_APPLICATION_RELEASE_TIME(opengl_graphics3d_landen);
IMPLEMENT_APPLICATION_FACTORY(opengl_graphics3d_landen);
...
namespace opengl_graphics3d_landen
{
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item <::opengl_graphics3d_landen::document >();
      factory()->add_factory_item <::opengl_graphics3d_landen::frame >();
      //factory()->add_factory_item <::app_core_vulken::edit_impact >();
      factory()->add_factory_item <::opengl_graphics3d_landen::impact >();
      ...
      add_impact_system(
         "main"_ansi, __initialize_new ::user::single_document_template(
                          "main"_ansi,
                          ::type < ::opengl_graphics3d_landen::document >(),
                          ::type < ::opengl_graphics3d_landen::frame >(),       // top level SDI frame::windowing::window
                        ::type < ::opengl_graphics3d_landen::impact >()));
