...
__IMPLEMENT_APPLICATION_RELEASE_TIME(opengl_graphics3d_continuum);
IMPLEMENT_APPLICATION_FACTORY(opengl_graphics3d_continuum);
...
namespace opengl_graphics3d_continuum
{
   ...
   application::application()
   {
      ...
      m_strAppId = "opengl-graphics3d/continuum";

      m_strAppName = "opengl-graphics3d/continuum";

      m_strBaseSupportId = "opengl_graphics3d_continuum";
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item <::opengl_graphics3d_continuum::document >();
      factory()->add_factory_item <::opengl_graphics3d_continuum::main_frame >();
      factory()->add_factory_item <::opengl_graphics3d_continuum::impact >();
      factory()->add_factory_item <::opengl_graphics3d_continuum::pane_impact >();
