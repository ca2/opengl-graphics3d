#include "framework.h"
#include "vk_device.h"
#include "opengl-graphics3d/graphics3d_opengl/container.h"
#include "opengl-graphics3d/graphics3d_opengl/OpenGLInitializers.h"
...
namespace vkc
{
   ...
   //VkcDevice::VkcDevice(vks::OpenGLDevice* pdevice) : m_vkdevice{pdevice->logicalDevice} {
   VkcDevice::VkcDevice()
   {
