...
//#include "opengl/vk_container.h"


int run_opengl_example();

int run_opengl_example2(const ::function < void(void*, int, int, int)>& callback);

int run_opengl_example5(::cube::mouse_state* pmousestate, const ::function < void(void*, int, int, int)>& callback);
...
//
//
//   ::pointer<::opengl::application > start_offscreen_application(vkc::VkContainer* pvkcontainer, mouse_state* pmousestate);
//
//
//} // namespace opengl
//
...
namespace opengl_graphics3d_landen
{
   ...
   //   //return ::opengl::start_offscreen_application(this, &m_mousestate);
