...
__IMPLEMENT_APPLICATION_RELEASE_TIME(opengl_graphics3d_MyPlace2025);
IMPLEMENT_APPLICATION_FACTORY(opengl_graphics3d_MyPlace2025);
...
namespace opengl_graphics3d_MyPlace2025
{
   ...
   application::application()
   {
      ...
      m_strBaseSupportId = "opengl_graphics3d_MyPlace2025";
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item <::opengl_graphics3d_MyPlace2025::document >();
      factory()->add_factory_item <::opengl_graphics3d_MyPlace2025::main_frame >();
      factory()->add_factory_item <::opengl_graphics3d_MyPlace2025::impact >();
      factory()->add_factory_item <::opengl_graphics3d_MyPlace2025::pane_impact >();
