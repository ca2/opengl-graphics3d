...
#if defined(_opengl_land_MyPlace2025_project)
#define CLASS_DECL_OPENGL_LAND_MYPLACE2025  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_OPENGL_LAND_MYPLACE2025  CLASS_DECL_IMPORT
#endif
